...
static PyMethodDef __pyx_methods[] = {
  {"dlogistic", (PyCFunction)__pyx_pw_11logistic_cy_1dlogistic, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_logistic_cy(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init logistic_cy", 0, __pyx_lineno, __pyx_filename);
    }
