...
from rl.hyreps.v1 import rSLDS
from rl.hyreps.v1 import HyREPS_V
...
if __name__ == "__main__":
    ...
    pndl_rslds = rSLDS(n_states, n_actions, n_regions, dyn_prior, ctl_prior)
    pndl_rslds.load('reps_pndlv1_rslds.pickle')
